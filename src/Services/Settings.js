...
export const settings = {
  ...
  ORDERS: {
    ...
    GET_COOKED_DELIVERED_ORDERS_PAGINATION: `${BASE_URLS.APP_BASEURL}/api/order/get-cooked-delivered-orders?access_token=$[access_token]&page=$[page]&limit=$[limit]`,
    ...
    GET_TODAY_ORDERS_PAGINATION: `${BASE_URLS.APP_BASEURL}/api/order/get-company-orders?access_token=$[access_token]&is_today=1&page=$[page]&limit=$[limit]`,
    GET_OTHER_ORDERS_PAGINATION: `${BASE_URLS.APP_BASEURL}/api/order/get-company-orders?access_token=$[access_token]&is_today=0&page=$[page]&limit=$[limit]`,
  },
  ONE_SIGNAL: {
